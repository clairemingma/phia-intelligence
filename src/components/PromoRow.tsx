...
/**
 * One promotional code as a shopper sees it. Used both for the list on the
 * partner page and as the live preview in the create-a-promo-code flow.
 */
export default function PromoRow({ promo }: { promo: Promo }) {
